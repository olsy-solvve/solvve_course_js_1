...
export default {
  data() {
    return {
      linkToGitHub: "https://github.com/olsy-solvve/solvve_course_js_1.git",
    };
  },
  methods: {
...
<template>
  <MainComponent>
    <div class="grid col-12 m-0 p-0 h-auto">
      ...
      <div class="col-12 lg:col-6 p-1 sm:p-3">
        <div class="text-center col-12 md:col-10 col-offset-0 md:col-offset-2">
          <h3>
            Sure, we`ve been around the block. We probably worked with the
            people who built it.
          </h3>
          <p class="text-justify text-xs sm:text-base lg:text-lg">
            Dui ut ornare lectus sit. Tincidunt lobortis feugiat vivamus at
            augue eget arcu. Vulputate mi sit amet mauris commodo quis imperdiet
            massa tincidunt. Sodales neque sodales ut etiam sit amet nisl.
      ...
      <div class="col-12 p-2 sm:p-3">
        ...
        <p class="text-justify text-xs sm:text-base lg:text-lg">
          ...
          dignissimos officiis veritatis obcaecati omnis numquam veniam eius
          minus quia. Inventore libero dolorem unde aliquid id quos totam
          voluptatibus mollitia sunt sit ad architecto accusantium natus,
          exercitationem recusandae ipsam laborum, aspernatur corporis, a
          molestiae laudantium impedit hic? Culpa ratione expedita corrupti
          soluta iusto eius accusamus adipisci ad distinctio nulla error,
          aliquid dignissimos deserunt consequatur odio? Unde a fugiat vero
          omnis assumenda quia veritatis, minus incidunt asperiores veniam!
          Atque tenetur nisi tempora doloremque voluptatem recusandae obcaecati
          corporis, modi, beatae quisquam, voluptatibus iusto? Eius labore
          aliquid quisquam voluptatum itaque, quasi saepe voluptatem, nam cum
          iure facilis nisi alias cumque repudiandae dolores harum pariatur
          dolorum iste laboriosam. Veritatis quaerat nam culpa. Enim rem, iste
          fugiat nesciunt distinctio corrupti rerum at ullam ipsa officiis
          ratione mollitia sit ipsam labore animi.
        </p>
      </div>
    </div>
  </MainComponent>
